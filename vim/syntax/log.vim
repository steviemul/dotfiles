...
syn match log_info   '\c\<\(INFO\|DEBUG\)'
...
highlight   log_error     ctermfg=Red cterm=bold
highlight   log_warning   ctermfg=Yellow cterm=bold
highlight   log_info      ctermfg=Blue cterm=bold
